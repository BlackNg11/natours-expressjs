      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('succes', 'Login thanh cong');
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('err', 'err logging out! try again');
...
var updateSetting = function updateSetting(data, type) {
  var _url, res;
  ...
  return regeneratorRuntime.async(function updateSetting$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
          _context.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: _url,
...
var stripe = Stripe('pk_test_mB2pN6z0Z0fIXdmdd6kpZ72B00QCIE4xZo');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return regeneratorRuntime.awrap((0, _updateSetting.updateSetting)({
